...
var (
	...
	DbGcPnlMergeTime   = metrics.GetOrCreateSummary(`db_gc_pnl_merge_time`) //nolint
	DbGcPnlMergeVolume = metrics.NewCounter(`db_gc_pnl_merge_volume`)       //nolint
	DbGcPnlMergeCalls  = metrics.NewCounter(`db_gc_pnl_merge_calls`)        //nolint
