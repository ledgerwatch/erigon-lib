...
var file_execution_execution_proto_rawDesc = []byte{
	...
	0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11,
	0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61,
	0x6c, 0x52, 0x0b, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x73, 0x2a, 0x5b,
	...
	,
	...
	0x63, 0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x12, 0x49, 0x0a, 0x0d, 0x41, 0x73, 0x73,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x74, 0x79,
	0x70, 0x65, 0x73, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79,
	0x6c, 0x6f, 0x61, 0x64, 0x12, 0x47, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x46, 0x6f, 0x72, 0x6b, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x42, 0x17,
...
var file_execution_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_execution_execution_proto_goTypes = []interface{}{
	...
	(*types.H2048)(nil),                 // 18: types.H2048
	(*types.Withdrawal)(nil),            // 19: types.Withdrawal
...
var file_execution_execution_proto_depIdxs = []int32{
	...
	16, // 1: execution.ForkChoiceReceipt.latest_valid_hash:type_name -> types.H256
	0,  // 2: execution.ValidationReceipt.validation_status:type_name -> execution.ValidationStatus
	16, // 3: execution.ValidationReceipt.latest_valid_hash:type_name -> types.H256
	16, // 4: execution.ValidationReceipt.missing_hash:type_name -> types.H256
	16, // 5: execution.Header.parent_hash:type_name -> types.H256
	17, // 6: execution.Header.coinbase:type_name -> types.H160
	16, // 7: execution.Header.state_root:type_name -> types.H256
	16, // 8: execution.Header.receipt_root:type_name -> types.H256
	18, // 9: execution.Header.logs_bloom:type_name -> types.H2048
	16, // 10: execution.Header.prev_randao:type_name -> types.H256
	16, // 11: execution.Header.difficulty:type_name -> types.H256
	16, // 12: execution.Header.block_hash:type_name -> types.H256
	16, // 13: execution.Header.ommer_hash:type_name -> types.H256
	16, // 14: execution.Header.transaction_hash:type_name -> types.H256
	16, // 15: execution.Header.base_fee_per_gas:type_name -> types.H256
	16, // 16: execution.Header.withdrawal_hash:type_name -> types.H256
	16, // 17: execution.BlockBody.block_hash:type_name -> types.H256
	4,  // 18: execution.BlockBody.uncles:type_name -> execution.Header
	19, // 19: execution.BlockBody.withdrawals:type_name -> types.Withdrawal
	...
	16, // 22: execution.GetSegmentRequest.block_hash:type_name -> types.H256
	...
	16, // 25: execution.ForkChoice.head_block_hash:type_name -> types.H256
	16, // 26: execution.ForkChoice.finalized_block_hash:type_name -> types.H256
	16, // 27: execution.ForkChoice.safe_block_hash:type_name -> types.H256
	0,  // 28: execution.InsertionResult.result:type_name -> execution.ValidationStatus
	16, // 29: execution.ValidationRequest.hash:type_name -> types.H256
	16, // 30: execution.AssembleBlockRequest.parentHash:type_name -> types.H256
	16, // 31: execution.AssembleBlockRequest.mixDigest:type_name -> types.H256
	17, // 32: execution.AssembleBlockRequest.suggestedFeeRecipent:type_name -> types.H160
	19, // 33: execution.AssembleBlockRequest.withdrawals:type_name -> types.Withdrawal
	10, // 34: execution.Execution.InsertHeaders:input_type -> execution.InsertHeadersRequest
	11, // 35: execution.Execution.InsertBodies:input_type -> execution.InsertBodiesRequest
	14, // 36: execution.Execution.ValidateChain:input_type -> execution.ValidationRequest
	12, // 37: execution.Execution.UpdateForkChoice:input_type -> execution.ForkChoice
	15, // 38: execution.Execution.AssembleBlock:input_type -> execution.AssembleBlockRequest
	9,  // 39: execution.Execution.GetHeader:input_type -> execution.GetSegmentRequest
	9,  // 40: execution.Execution.GetBody:input_type -> execution.GetSegmentRequest
	16, // 41: execution.Execution.IsCanonicalHash:input_type -> types.H256
	16, // 42: execution.Execution.GetHeaderHashNumber:input_type -> types.H256
	20, // 43: execution.Execution.GetForkChoice:input_type -> google.protobuf.Empty
	13, // 44: execution.Execution.InsertHeaders:output_type -> execution.InsertionResult
	13, // 45: execution.Execution.InsertBodies:output_type -> execution.InsertionResult
	2,  // 46: execution.Execution.ValidateChain:output_type -> execution.ValidationReceipt
	1,  // 47: execution.Execution.UpdateForkChoice:output_type -> execution.ForkChoiceReceipt
	21, // 48: execution.Execution.AssembleBlock:output_type -> types.ExecutionPayload
	6,  // 49: execution.Execution.GetHeader:output_type -> execution.GetHeaderResponse
	7,  // 50: execution.Execution.GetBody:output_type -> execution.GetBodyResponse
	3,  // 51: execution.Execution.IsCanonicalHash:output_type -> execution.IsCanonicalResponse
	8,  // 52: execution.Execution.GetHeaderHashNumber:output_type -> execution.GetHeaderHashNumberResponse
	12, // 53: execution.Execution.GetForkChoice:output_type -> execution.ForkChoice
