...
var file_execution_execution_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x6f, 0x62, 0x73, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x22, 0x5c, 0x0a, 0x19, 0x47,
	0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x6d, 0x62, 0x6c, 0x65, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x42, 0x07, 0x0a, 0x05, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x5b, 0x0a, 0x10, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a,
	...
	0x69, 0x6e, 0x67, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04,
	0x42, 0x75, 0x73, 0x79, 0x10, 0x05, 0x32, 0xc9, 0x06, 0x0a, 0x09, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a, 0x0d, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x48, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x73, 0x12, 0x1f, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x52,
	...
	0x6c, 0x74, 0x12, 0x4a, 0x0a, 0x0c, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x42, 0x6f, 0x64, 0x69,
	0x65, 0x73, 0x12, 0x1e, 0x2e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x49,
	...
	0x73, 0x65, 0x12, 0x3e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x46, 0x6f, 0x72, 0x6b, 0x43, 0x68, 0x6f,
	...
	0x63, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x2e, 0x2f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
...
var file_execution_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_execution_execution_proto_goTypes = []interface{}{
	...
	(*AssembledBlockData)(nil),          // 18: execution.AssembledBlockData
	(*GetAssembledBlockResponse)(nil),   // 19: execution.GetAssembledBlockResponse
	(*types.H256)(nil),                  // 20: types.H256
	(*types.H160)(nil),                  // 21: types.H160
	(*types.H2048)(nil),                 // 22: types.H2048
	(*types.Withdrawal)(nil),            // 23: types.Withdrawal
	(*types.ExecutionPayload)(nil),      // 24: types.ExecutionPayload
	(*types.BlobsBundleV1)(nil),         // 25: types.BlobsBundleV1
...
var file_execution_execution_proto_depIdxs = []int32{
	...
	20, // 1: execution.ForkChoiceReceipt.latest_valid_hash:type_name -> types.H256
	0,  // 2: execution.ValidationReceipt.validation_status:type_name -> execution.ValidationStatus
	20, // 3: execution.ValidationReceipt.latest_valid_hash:type_name -> types.H256
	20, // 4: execution.ValidationReceipt.missing_hash:type_name -> types.H256
	20, // 5: execution.Header.parent_hash:type_name -> types.H256
	21, // 6: execution.Header.coinbase:type_name -> types.H160
	20, // 7: execution.Header.state_root:type_name -> types.H256
	20, // 8: execution.Header.receipt_root:type_name -> types.H256
	22, // 9: execution.Header.logs_bloom:type_name -> types.H2048
	20, // 10: execution.Header.prev_randao:type_name -> types.H256
	20, // 11: execution.Header.difficulty:type_name -> types.H256
	20, // 12: execution.Header.block_hash:type_name -> types.H256
	20, // 13: execution.Header.ommer_hash:type_name -> types.H256
	20, // 14: execution.Header.transaction_hash:type_name -> types.H256
	20, // 15: execution.Header.base_fee_per_gas:type_name -> types.H256
	20, // 16: execution.Header.withdrawal_hash:type_name -> types.H256
	20, // 17: execution.BlockBody.block_hash:type_name -> types.H256
	4,  // 18: execution.BlockBody.uncles:type_name -> execution.Header
	23, // 19: execution.BlockBody.withdrawals:type_name -> types.Withdrawal
	...
	20, // 22: execution.GetSegmentRequest.block_hash:type_name -> types.H256
	...
	20, // 25: execution.ForkChoice.head_block_hash:type_name -> types.H256
	20, // 26: execution.ForkChoice.finalized_block_hash:type_name -> types.H256
	20, // 27: execution.ForkChoice.safe_block_hash:type_name -> types.H256
	0,  // 28: execution.InsertionResult.result:type_name -> execution.ValidationStatus
	20, // 29: execution.ValidationRequest.hash:type_name -> types.H256
	20, // 30: execution.AssembleBlockRequest.parentHash:type_name -> types.H256
	20, // 31: execution.AssembleBlockRequest.mixDigest:type_name -> types.H256
	21, // 32: execution.AssembleBlockRequest.suggestedFeeRecipent:type_name -> types.H160
	23, // 33: execution.AssembleBlockRequest.withdrawals:type_name -> types.Withdrawal
	24, // 34: execution.AssembledBlockData.execution_payload:type_name -> types.ExecutionPayload
	20, // 35: execution.AssembledBlockData.block_value:type_name -> types.H256
	25, // 36: execution.AssembledBlockData.blobs_bundle:type_name -> types.BlobsBundleV1
	18, // 37: execution.GetAssembledBlockResponse.data:type_name -> execution.AssembledBlockData
	10, // 38: execution.Execution.InsertHeaders:input_type -> execution.InsertHeadersRequest
	11, // 39: execution.Execution.InsertBodies:input_type -> execution.InsertBodiesRequest
	14, // 40: execution.Execution.ValidateChain:input_type -> execution.ValidationRequest
	12, // 41: execution.Execution.UpdateForkChoice:input_type -> execution.ForkChoice
	15, // 42: execution.Execution.AssembleBlock:input_type -> execution.AssembleBlockRequest
	17, // 43: execution.Execution.GetAssembledBlock:input_type -> execution.GetAssembledBlockRequest
	9,  // 44: execution.Execution.GetHeader:input_type -> execution.GetSegmentRequest
	9,  // 45: execution.Execution.GetBody:input_type -> execution.GetSegmentRequest
	20, // 46: execution.Execution.IsCanonicalHash:input_type -> types.H256
	20, // 47: execution.Execution.GetHeaderHashNumber:input_type -> types.H256
	26, // 48: execution.Execution.GetForkChoice:input_type -> google.protobuf.Empty
	13, // 49: execution.Execution.InsertHeaders:output_type -> execution.InsertionResult
	13, // 50: execution.Execution.InsertBodies:output_type -> execution.InsertionResult
	2,  // 51: execution.Execution.ValidateChain:output_type -> execution.ValidationReceipt
	1,  // 52: execution.Execution.UpdateForkChoice:output_type -> execution.ForkChoiceReceipt
	16, // 53: execution.Execution.AssembleBlock:output_type -> execution.AssembleBlockResponse
	19, // 54: execution.Execution.GetAssembledBlock:output_type -> execution.GetAssembledBlockResponse
	6,  // 55: execution.Execution.GetHeader:output_type -> execution.GetHeaderResponse
	7,  // 56: execution.Execution.GetBody:output_type -> execution.GetBodyResponse
	3,  // 57: execution.Execution.IsCanonicalHash:output_type -> execution.IsCanonicalResponse
	8,  // 58: execution.Execution.GetHeaderHashNumber:output_type -> execution.GetHeaderHashNumberResponse
	12, // 59: execution.Execution.GetForkChoice:output_type -> execution.ForkChoice
