...
var file_txpool_txpool_proto_rawDesc = []byte{
	...
	0x41, 0x53, 0x45, 0x5f, 0x46, 0x45, 0x45, 0x10, 0x02, 0x22, 0x40, 0x0a, 0x17, 0x54, 0x72, 0x61,
	...
	0x36, 0x30, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x43, 0x0a, 0x15, 0x54,
	...
	0x01, 0x28, 0x08, 0x52, 0x05, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f,
...
var file_txpool_txpool_proto_goTypes = []interface{}{
	...
	(*TransactionCountRequest)(nil), // 11: txpool.TransactionCountRequest
	(*TransactionCountReply)(nil),   // 12: txpool.TransactionCountReply
	(*StatusRequest)(nil),           // 13: txpool.StatusRequest
	(*StatusReply)(nil),             // 14: txpool.StatusReply
...
var file_txpool_txpool_proto_depIdxs = []int32{
	...
	13, // 12: txpool.Txpool.Status:input_type -> txpool.StatusRequest
	11, // 13: txpool.Txpool.GetTransactionCount:input_type -> txpool.TransactionCountRequest
	...
	14, // 20: txpool.Txpool.Status:output_type -> txpool.StatusReply
	12, // 21: txpool.Txpool.GetTransactionCount:output_type -> txpool.TransactionCountReply
