...
const (
	Action_UPDATE_STORAGE Action = 0 // Change only in the storage
	Action_UPSERT         Action = 1 // Change of balance or nonce (and optionally storage)
	Action_UPDATE_CODE    Action = 2 // Change of code (and optionally storage)
...
const (
	Domain_DOMAIN_ACCOUNT    Domain = 0
	Domain_DOMAIN_STORAGE    Domain = 1
	Domain_DOMAIN_CODE       Domain = 2
	Domain_DOMAIN_COMMITMENT Domain = 3
)
...
func (Domain) Descriptor() protoreflect.EnumDescriptor {
	return file_remote_kv_proto_enumTypes[3].Descriptor()
}

func (Domain) Type() protoreflect.EnumType {
	return &file_remote_kv_proto_enumTypes[3]
}
...
const (
	History_HISTORY_ACCOUNT    History = 0
	History_HISTORY_STORAGE    History = 1
	History_HISTORY_CODE       History = 2
	History_HISTORY_COMMITMENT History = 3
)

// Enum value maps for History.
var (
	History_name = map[int32]string{
		0: "HISTORY_ACCOUNT",
		1: "HISTORY_STORAGE",
		2: "HISTORY_CODE",
		3: "HISTORY_COMMITMENT",
	}
	History_value = map[string]int32{
		"HISTORY_ACCOUNT":    0,
		"HISTORY_STORAGE":    1,
		"HISTORY_CODE":       2,
		"HISTORY_COMMITMENT": 3,
	}
)

func (x History) Enum() *History {
	p := new(History)
	*p = x
	return p
}
...
func (History) Descriptor() protoreflect.EnumDescriptor {
	return file_remote_kv_proto_enumTypes[4].Descriptor()
}

func (History) Type() protoreflect.EnumType {
	return &file_remote_kv_proto_enumTypes[4]
}

func (x History) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use History.Descriptor instead.
func (History) EnumDescriptor() ([]byte, []int) {
	return file_remote_kv_proto_rawDescGZIP(), []int{4}
}

type InvertedIdx int32

const (
	InvertedIdx_INVERTED_IDX_ACCOUNT    InvertedIdx = 0
	InvertedIdx_INVERTED_IDX_STORAGE    InvertedIdx = 1
	InvertedIdx_INVERTED_IDX_CODE       InvertedIdx = 2
	InvertedIdx_INVERTED_IDX_COMMITMENT InvertedIdx = 3
	InvertedIdx_INVERTED_IDX_LOG_TOPIC  InvertedIdx = 4
	InvertedIdx_INVERTED_IDX_LOG_ADDR   InvertedIdx = 5
	InvertedIdx_INVERTED_IDX_TRACE_FROM InvertedIdx = 6
	InvertedIdx_INVERTED_IDX_TRACE_TO   InvertedIdx = 7
)

// Enum value maps for InvertedIdx.
var (
	InvertedIdx_name = map[int32]string{
		0: "INVERTED_IDX_ACCOUNT",
		1: "INVERTED_IDX_STORAGE",
		2: "INVERTED_IDX_CODE",
		3: "INVERTED_IDX_COMMITMENT",
		4: "INVERTED_IDX_LOG_TOPIC",
		5: "INVERTED_IDX_LOG_ADDR",
		6: "INVERTED_IDX_TRACE_FROM",
		7: "INVERTED_IDX_TRACE_TO",
	}
	InvertedIdx_value = map[string]int32{
		"INVERTED_IDX_ACCOUNT":    0,
		"INVERTED_IDX_STORAGE":    1,
		"INVERTED_IDX_CODE":       2,
		"INVERTED_IDX_COMMITMENT": 3,
		"INVERTED_IDX_LOG_TOPIC":  4,
		"INVERTED_IDX_LOG_ADDR":   5,
		"INVERTED_IDX_TRACE_FROM": 6,
		"INVERTED_IDX_TRACE_TO":   7,
	}
)

func (x InvertedIdx) Enum() *InvertedIdx {
	p := new(InvertedIdx)
	*p = x
	return p
}

func (x InvertedIdx) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (InvertedIdx) Descriptor() protoreflect.EnumDescriptor {
	return file_remote_kv_proto_enumTypes[5].Descriptor()
}

func (InvertedIdx) Type() protoreflect.EnumType {
	return &file_remote_kv_proto_enumTypes[5]
}

func (x InvertedIdx) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use InvertedIdx.Descriptor instead.
func (InvertedIdx) EnumDescriptor() ([]byte, []int) {
...
type DomainGetReq struct {
	...
	TxId uint64 `protobuf:"varint,1,opt,name=tx_id,json=txId,proto3" json:"tx_id,omitempty"` // returned by .Tx()
	// query params
	Table  Domain `protobuf:"varint,2,opt,name=table,proto3,enum=remote.Domain" json:"table,omitempty"`
...
func (x *DomainGetReq) GetTable() Domain {
	if x != nil {
		return x.Table
	}
	return Domain_DOMAIN_ACCOUNT
}
...
type HistoryGetReq struct {
	...
	TxId  uint64  `protobuf:"varint,1,opt,name=tx_id,json=txId,proto3" json:"tx_id,omitempty"` // returned by .Tx()
	Table History `protobuf:"varint,2,opt,name=table,proto3,enum=remote.History" json:"table,omitempty"`
	K     []byte  `protobuf:"bytes,3,opt,name=k,proto3" json:"k,omitempty"`
	Ts    uint64  `protobuf:"varint,4,opt,name=ts,proto3" json:"ts,omitempty"`
}
...
func (x *HistoryGetReq) GetTable() History {
	if x != nil {
		return x.Table
	}
	return History_HISTORY_ACCOUNT
}
...
type IndexRangeReq struct {
	...
	TxId uint64 `protobuf:"varint,1,opt,name=tx_id,json=txId,proto3" json:"tx_id,omitempty"` // returned by .Tx()
	// query params
	Table       InvertedIdx `protobuf:"varint,2,opt,name=table,proto3,enum=remote.InvertedIdx" json:"table,omitempty"`
	K           []byte      `protobuf:"bytes,3,opt,name=k,proto3" json:"k,omitempty"`
...
func (x *IndexRangeReq) GetTable() InvertedIdx {
	if x != nil {
		return x.Table
	}
	return InvertedIdx_INVERTED_IDX_ACCOUNT
}
...
var file_remote_kv_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x22, 0x8f, 0x01, 0x0a, 0x0c, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x12, 0x13, 0x0a, 0x05, 0x74, 0x78, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x04, 0x74, 0x78, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x05, 0x74, 0x61, 0x62, 0x6c,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	0x2e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x0c,
	...
	0x52, 0x02, 0x6f, 0x6b, 0x22, 0x69, 0x0a, 0x0d, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x47,
	0x65, 0x74, 0x52, 0x65, 0x71, 0x12, 0x13, 0x0a, 0x05, 0x74, 0x78, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x74, 0x78, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x05, 0x74, 0x61,
	0x62, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x72, 0x65, 0x6d, 0x6f,
	0x74, 0x65, 0x2e, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c,
	...
	0x2f, 0x0a, 0x0f, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x0a, 0x05, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x10, 0x1f, 0x12, 0x11, 0x0a, 0x0d, 0x4f, 0x50,
	0x45, 0x4e, 0x5f, 0x44, 0x55, 0x50, 0x5f, 0x53, 0x4f, 0x52, 0x54, 0x10, 0x20, 0x12, 0x09, 0x0a,
	0x05, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x10, 0x21, 0x2a, 0x56, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x0e, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x5f, 0x53, 0x54, 0x4f,
	0x52, 0x41, 0x47, 0x45, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x55, 0x50, 0x53, 0x45, 0x52, 0x54,
	0x10, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x5f, 0x43, 0x4f, 0x44,
	...
	,
	...
	,
...
var file_remote_kv_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_remote_kv_proto_goTypes = []interface{}{
	...
	(Domain)(0),                // 3: remote.Domain
	(History)(0),               // 4: remote.History
	(InvertedIdx)(0),           // 5: remote.InvertedIdx
	(*Cursor)(nil),             // 6: remote.Cursor
	(*Pair)(nil),               // 7: remote.Pair
	(*StorageChange)(nil),      // 8: remote.StorageChange
	(*AccountChange)(nil),      // 9: remote.AccountChange
	(*StateChangeBatch)(nil),   // 10: remote.StateChangeBatch
	(*StateChange)(nil),        // 11: remote.StateChange
	(*StateChangeRequest)(nil), // 12: remote.StateChangeRequest
	(*SnapshotsRequest)(nil),   // 13: remote.SnapshotsRequest
	(*SnapshotsReply)(nil),     // 14: remote.SnapshotsReply
	(*RangeReq)(nil),           // 15: remote.RangeReq
	(*DomainGetReq)(nil),       // 16: remote.DomainGetReq
	(*DomainGetReply)(nil),     // 17: remote.DomainGetReply
	(*HistoryGetReq)(nil),      // 18: remote.HistoryGetReq
	(*HistoryGetReply)(nil),    // 19: remote.HistoryGetReply
	(*IndexRangeReq)(nil),      // 20: remote.IndexRangeReq
	(*IndexRangeReply)(nil),    // 21: remote.IndexRangeReply
	(*HistoryRangeReq)(nil),    // 22: remote.HistoryRangeReq
	(*DomainRangeReq)(nil),     // 23: remote.DomainRangeReq
	(*Pairs)(nil),              // 24: remote.Pairs
	(*ParisPagination)(nil),    // 25: remote.ParisPagination
	(*IndexPagination)(nil),    // 26: remote.IndexPagination
...
var file_remote_kv_proto_depIdxs = []int32{
	...
	27, // 1: remote.StorageChange.location:type_name -> types.H256
	28, // 2: remote.AccountChange.address:type_name -> types.H160
	1,  // 3: remote.AccountChange.action:type_name -> remote.Action
	8,  // 4: remote.AccountChange.storage_changes:type_name -> remote.StorageChange
	11, // 5: remote.StateChangeBatch.change_batch:type_name -> remote.StateChange
	2,  // 6: remote.StateChange.direction:type_name -> remote.Direction
	27, // 7: remote.StateChange.block_hash:type_name -> types.H256
	9,  // 8: remote.StateChange.changes:type_name -> remote.AccountChange
	3,  // 9: remote.DomainGetReq.table:type_name -> remote.Domain
	4,  // 10: remote.HistoryGetReq.table:type_name -> remote.History
	5,  // 11: remote.IndexRangeReq.table:type_name -> remote.InvertedIdx
	29, // 12: remote.KV.Version:input_type -> google.protobuf.Empty
	6,  // 13: remote.KV.Tx:input_type -> remote.Cursor
	12, // 14: remote.KV.StateChanges:input_type -> remote.StateChangeRequest
	13, // 15: remote.KV.Snapshots:input_type -> remote.SnapshotsRequest
	15, // 16: remote.KV.Range:input_type -> remote.RangeReq
	16, // 17: remote.KV.DomainGet:input_type -> remote.DomainGetReq
	18, // 18: remote.KV.HistoryGet:input_type -> remote.HistoryGetReq
	20, // 19: remote.KV.IndexRange:input_type -> remote.IndexRangeReq
	22, // 20: remote.KV.HistoryRange:input_type -> remote.HistoryRangeReq
	23, // 21: remote.KV.DomainRange:input_type -> remote.DomainRangeReq
	30, // 22: remote.KV.Version:output_type -> types.VersionReply
	7,  // 23: remote.KV.Tx:output_type -> remote.Pair
	10, // 24: remote.KV.StateChanges:output_type -> remote.StateChangeBatch
	14, // 25: remote.KV.Snapshots:output_type -> remote.SnapshotsReply
	24, // 26: remote.KV.Range:output_type -> remote.Pairs
	17, // 27: remote.KV.DomainGet:output_type -> remote.DomainGetReply
	19, // 28: remote.KV.HistoryGet:output_type -> remote.HistoryGetReply
	21, // 29: remote.KV.IndexRange:output_type -> remote.IndexRangeReply
	24, // 30: remote.KV.HistoryRange:output_type -> remote.Pairs
	24, // 31: remote.KV.DomainRange:output_type -> remote.Pairs
