...
const (
	// Lightclient gossip
	GossipType_GOSSIP_TYPE_LIGHT_CLIENT_FINALITY_UPDATE   GossipType = 0
	GossipType_GOSSIP_TYPE_LIGHT_CLIENT_OPTIMISTIC_UPDATE GossipType = 1
	// Legacy gossip
	GossipType_GOSSIP_TYPE_BEACON_BLOCK GossipType = 2
	// Global gossip topics.
	GossipType_GOSSIP_TYPE_AGGREGATE_AND_PROOF GossipType = 3
	GossipType_GOSSIP_TYPE_VOLUNTARY_EXIT      GossipType = 4
	GossipType_GOSSIP_TYPE_PROPOSER_SLASHING   GossipType = 5
	GossipType_GOSSIP_TYPE_ATTESTER_SLASHING   GossipType = 6
)

// Enum value maps for GossipType.
var (
	GossipType_name = map[int32]string{
		0: "GOSSIP_TYPE_LIGHT_CLIENT_FINALITY_UPDATE",
		1: "GOSSIP_TYPE_LIGHT_CLIENT_OPTIMISTIC_UPDATE",
		2: "GOSSIP_TYPE_BEACON_BLOCK",
		3: "GOSSIP_TYPE_AGGREGATE_AND_PROOF",
		4: "GOSSIP_TYPE_VOLUNTARY_EXIT",
		5: "GOSSIP_TYPE_PROPOSER_SLASHING",
		6: "GOSSIP_TYPE_ATTESTER_SLASHING",
	}
	GossipType_value = map[string]int32{
		"GOSSIP_TYPE_LIGHT_CLIENT_FINALITY_UPDATE":   0,
		"GOSSIP_TYPE_LIGHT_CLIENT_OPTIMISTIC_UPDATE": 1,
		"GOSSIP_TYPE_BEACON_BLOCK":                   2,
		"GOSSIP_TYPE_AGGREGATE_AND_PROOF":            3,
		"GOSSIP_TYPE_VOLUNTARY_EXIT":                 4,
		"GOSSIP_TYPE_PROPOSER_SLASHING":              5,
		"GOSSIP_TYPE_ATTESTER_SLASHING":              6,
	}
)
...
func (x *GossipData) GetType() GossipType {
	...
	return GossipType_GOSSIP_TYPE_LIGHT_CLIENT_FINALITY_UPDATE
}
...
var file_p2psentinel_sentinel_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x64, 0x22, 0x7c, 0x0a, 0x0a, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x28, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x73, 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6c, 0x2e, 0x47,
	0x6f, 0x73, 0x73, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12,
	...
	0x74, 0x22, 0x23, 0x0a, 0x09, 0x50, 0x65, 0x65, 0x72, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06,
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x37, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
...
var file_p2psentinel_sentinel_proto_depIdxs = []int32{
	...
	1,  // 4: sentinel.Sentinel.SubscribeGossip:input_type -> sentinel.EmptyMessage
	...
	1,  // 7: sentinel.Sentinel.GetPeers:input_type -> sentinel.EmptyMessage
	2,  // 8: sentinel.Sentinel.BanPeer:input_type -> sentinel.Peer
	3,  // 9: sentinel.Sentinel.PublishGossip:input_type -> sentinel.GossipData
	3,  // 10: sentinel.Sentinel.SubscribeGossip:output_type -> sentinel.GossipData
	7,  // 11: sentinel.Sentinel.SendRequest:output_type -> sentinel.ResponseData
	1,  // 12: sentinel.Sentinel.SetStatus:output_type -> sentinel.EmptyMessage
	5,  // 13: sentinel.Sentinel.GetPeers:output_type -> sentinel.PeerCount
	1,  // 14: sentinel.Sentinel.BanPeer:output_type -> sentinel.EmptyMessage
	1,  // 15: sentinel.Sentinel.PublishGossip:output_type -> sentinel.EmptyMessage
