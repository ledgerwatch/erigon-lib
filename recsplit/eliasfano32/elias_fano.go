...
func (ef *EliasFano) deriveFields() int {
	...
	fmt.Printf("EF: count=%d, u=%d, l=%d, totalWords=%d, wordsLowerBits=%d, wordsUpperBits=%d, jumpWords=%d\n", ef.count, ef.u, ef.l, totalWords, wordsLowerBits, wordsUpperBits, jumpWords)
	if ef.data == nil {
