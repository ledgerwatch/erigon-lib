...
func TestCompressDict1(t *testing.T) {
	...
	for g.HasNext() {
		// next word is `nil`
		require.False(t, g.MatchPrefix([]byte("long"), false))
		require.True(t, g.MatchPrefix([]byte(""), false))
		require.True(t, g.MatchPrefix([]byte{}, false))
		word, _ := g.Next(nil)
		require.Nil(t, word)

		// next word is `long`
		require.True(t, g.MatchPrefix([]byte("long"), false))
		require.False(t, g.MatchPrefix([]byte("longlong"), false))
		require.False(t, g.MatchPrefix([]byte("wordnotmatch"), false))
		require.False(t, g.MatchPrefix([]byte("longnotmatch"), false))
		require.True(t, g.MatchPrefix([]byte{}, false))
		_, _ = g.Next(nil)
		...
		require.False(t, g.MatchPrefix([]byte("long"), false))
		require.False(t, g.MatchPrefix([]byte("longlong"), false))
		require.True(t, g.MatchPrefix([]byte("word"), false))
		require.True(t, g.MatchPrefix([]byte(""), false))
		require.True(t, g.MatchPrefix(nil, false))
		require.False(t, g.MatchPrefix([]byte("wordnotmatch"), false))
		require.False(t, g.MatchPrefix([]byte("longnotmatch"), false))
		_, _ = g.Next(nil)
		...
		require.True(t, g.MatchPrefix([]byte("long"), false))
		require.True(t, g.MatchPrefix([]byte("longlong"), false))
		require.True(t, g.MatchPrefix([]byte("longlongword "), false))
		require.False(t, g.MatchPrefix([]byte("wordnotmatch"), false))
		require.False(t, g.MatchPrefix([]byte("longnotmatch"), false))
		require.True(t, g.MatchPrefix([]byte{}, false))
		word, _ = g.Next(nil)
